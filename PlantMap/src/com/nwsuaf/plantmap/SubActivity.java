...
public class SubActivity extends AndroidApplication {
	@Override
...
final class MyGdxGame implements ApplicationListener {
	...
	public void render() {
		...
		batch.draw(walkAnimation.getKeyFrame(time, true), manPosition.x, manPosition.y, manPosition.width,
				manPosition.height);
