...
import com.nwsuaf.plantmap.CaptureActivity;
...
public final class CaptureActivityHandler extends Handler {
	...
	public final static int auto_focus = 0;
	...
	public final static int quit_preview = 5;
	...
	public void quitSynchronously() {
		...
		Message quit = Message.obtain(decodeThread.getHandler(), quit_preview);
		quit.sendToTarget();
		try {
			decodeThread.join();
