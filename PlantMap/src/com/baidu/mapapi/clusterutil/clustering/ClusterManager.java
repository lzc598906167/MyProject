...
public class ClusterManager<T extends ClusterItem>
	...
	public void setNarrow_button(Button narrow_button) {
		this.narrow_button = narrow_button;
	}
	...
	public void onMapStatusChange(MapStatus mapStatus) {
		...
		if (mapStatus.zoom < 17.000) {
			MapStatusUpdate u = MapStatusUpdateFactory.zoomTo((float) 17.000);
